...
export default function Tip({ navigation }) {
    const slides = [
        {
            ...
            image: require('../view/src/assents/1.png')
        },
        {
            key: '2',
            title: 'Teste 2',
            ...
            image: require('../view/src/assents/2.png')
        },
        {
            key: '3',
            title: 'Teste 3',
    ...
    function renderSlides({ item }) {
        return (
            <View style={{ flex: 1 }}>
                <Image source={item.image} style={{ resizeMode: 'contain', height: '60%', width: '100%', marginTop: 30 }} />
                <Text style={{ fontSize: 24, textAlign: 'center', fontWeight: 'bold', padding: 15, color: '#000' }}>{item.title}</Text>
                <ScrollView style={{ flex: 1, maxHeight: "20%" }}>
                    <Text style={{ marginHorizontal: 20, textAlign: 'center', fontSize: 17, color:"#000" }}>{item.text}</Text>
                </ScrollView>
            </View>
        )
    }
    return (
        <SafeAreaView style={{flex:1}}>
            <TouchableOpacity style={{position:'absolute', top:8, left:8, zIndex:2}} onPress={()=> navigation.navigate('Home')}>
